...
> **2026-08-18 硬件架构补充：** STM32 的传感器/本地规则职责已迁入
> ESP32-S3。超声 ECHO 通过 220Ω 电阻分压接 GPIO40，OpenMV P4/TX 直连 GPIO8；
> 单板固件已烧录并完成超声、视觉健康、LCD、HTTP上传实机验证。新权威接线和软件
> 边界见 `docs/ESP32_SINGLE_BOARD_MIGRATION.md`。本文其余硬件内容仍是
> 2026-08-14 三板系统的已验证基线和回滚证据。
